...
class HumanPlayer {
    ...
    makeMove(board) {
        if (this.position < this.moves.length &&
            ...
            board.board[this.moves[this.position][1] - 1][this.moves[this.position][0] - 1] = this.sign;
    ...
    play() {
        ...
        while (true) {
            ...
            if (configuration === -1) {
                ...
                return 0;
            } else if (configuration === choose[player].sign) {
...
class Tournament {
    ...
    start() {
        ...
        console.log('Number of games wasn\'t won by somebody: ' + this.statistics[0]);
